...
ALTER TABLE chapter_files ADD COLUMN process_retry_at TIMESTAMPTZ;
ALTER TABLE chapter_files ADD COLUMN process_error TEXT NOT NULL DEFAULT '';
ALTER TABLE chapter_files ADD COLUMN processed_at TIMESTAMPTZ;
-- size of the file as downloaded, before any processing (0 = unknown)
ALTER TABLE chapter_files ADD COLUMN size_original BIGINT NOT NULL DEFAULT 0;
