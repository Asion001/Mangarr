...
var Vars = [][3]string{
	...
	{"MANGARR_WORKER_PAGE_CONCURRENCY", "", "4"},
}
...
var Help = map[string]string{
	...
	"MANGARR_WORKER_CONCURRENT":       "Tasks it takes at once (0 = what the server says).",
	"MANGARR_WORKER_PREFETCH":         "Pages it fetches ahead of its uploads (0 = what the server says).",
	"MANGARR_WORKER_PAGE_CONCURRENCY": "Pages it fetches at a time.",
}
